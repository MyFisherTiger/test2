package com.kjs.medialibrary.video.hw.camera;
...
import com.kjs.medialibrary.video.hw.drawer.GLDrawer2D;
...
/**
 * 基于Surface的OpenGL封装，用于相机预览（包含了相机的启动）
 * 这种方式更高效直接将native层的数据给到编码器，减少拷贝
 */
